              ...
              <div className="rounded-[24px] bg-white p-4 shadow-sm">
                <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-slate-600">
                      Professionelles Archiv mit Kunde, Gerät, Ticket, Datum und Kategorie.
                    </p>
                  </div>
                  ...
                  <div className="mt-4 space-y-3">
                    {filteredDocuments.length === 0 ? (
                      ...
                      filteredDocuments.map((item) => (
                        <div
                          key={item.id}
                          className="flex flex-col gap-4 rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm md:flex-row md:items-start md:justify-between"
                        >
                          <div className="min-w-0">
